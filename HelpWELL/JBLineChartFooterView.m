...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        _leftLabel.font = [UIFont fontWithName:@"HelveticaNeue" size:10.0];
        ...
        _rightLabel.font = [UIFont fontWithName:@"HelveticaNeue" size:10.0];
...
- (void)layoutSubviews
{
    ...
    self.rightLabel.frame = CGRectMake(CGRectGetMaxX(_leftLabel.frame), yOffset, width-10, self.bounds.size.height);
}
